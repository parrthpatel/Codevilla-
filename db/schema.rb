...
ActiveRecord::Schema.define(version: 20160328100256) do
  ...
  add_index "categorises", ["categori_id"], name: "index_categorises_on_categori_id", using: :btree
  add_index "categorises", ["repository_id"], name: "index_categorises_on_repository_id", using: :btree
  ...
  add_foreign_key "categorises", "categoris"
  add_foreign_key "categorises", "repositories"
